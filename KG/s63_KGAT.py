...
def train( epochs = 20, batchSize = 1024, lr = 0.01, e_dim = 128, r_dim=64, n_neighbors=10,eva_per_epochs=1 ):
    ...
    net = KGAT( max( users ) + 1, max( entitys ) + 1, max( relations ) + 1 ,
                e_dim, r_dim ,adj_entity, adj_relation)
